                ...
                <Table.Row key={service.id}>
                    ...
                    <Table.Cell textAlign="center">
                        <Modal id="updatemodal" trigger={<Button color="yellow"><Icon name="edit" />Edit</Button>}>
                            <Modal.Header as='h3'> Customer Details </Modal.Header>
                            <Modal.Content>
        ...
        return (
            <React.Fragment>
                ...
                <Modal id="modal" trigger={<Button color="blue" id="buttonModal">Add a new customer</Button>}  >
                    <Modal.Header as='h3'>Add a new customer</Modal.Header>
                    <Modal.Content>
                        <Form onSubmit={this.add} ref="form" method="POST">
                            <Form.Field>
                                <Label color="grey">Name: </Label>
                                <input type="text" placeholder="Type a Customer name" name="name" required />
                            </Form.Field>
                            <br />
                            <Form.Field>
                                <Label color="grey">Address</Label>
                                <input type="text" placeholder="Customer address" name="address" /><br />
                            </Form.Field>
                            <br />
                ...
                <Table className="ui striped table">
                    <Table.Header>
                        <Table.Row textAlign="center">
                            <Table.HeaderCell className="five wide">Customer name</Table.HeaderCell>
                            <Table.HeaderCell className="five wide">Customer address</Table.HeaderCell>
